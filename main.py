...
# Importando as classes da pasta pacote 'classes'
...
from classes.pagamento import PagamentoPix           # Pronto para uso
...
from classes.pagamento import PagamentoPix #ainda não implementado, mas vamos deixar aqui para quando for implementar
